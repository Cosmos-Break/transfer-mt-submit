import transformers
from transformers import AutoTokenizer, AutoModelForSeq2SeqLM, MarianMTModel, MarianConfig
from transformers.models.marian.modeling_marian import *
from transformers.models.marian.modeling_marian import _expand_mask
import json
from typing import *
...
class MyMarianEncoder(MarianPreTrainedModel):
    def __init__(self, config: MarianConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        # 可训练的embedding层
        # self.trainable_embedding = nn.Embedding(50000, embed_dim, self.padding_idx)
        self.trainable_embedding = nn.Embedding(50000, embed_dim, 3)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            mask = input_ids >= self.embed_tokens.num_embeddings
            ...
            # print('pretrained_batch', pretrained_batch)

            inputs_embeds = self.embed_tokens(pretrained_batch)
            # print('inputs_embeds', inputs_embeds)

            # Every token without representation has to be brought into appropriate range
            input_ids -= self.embed_tokens.num_embeddings
            # print('mask', mask)
            # print('~mask', ~mask)
            ...
            non_pretrained_embedded_batch = self.trainable_embedding(input_ids)
