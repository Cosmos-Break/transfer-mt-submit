...
def batch_tokenize_fn(examples):
    ...
    if not sources:
        sources, targets = targets.split('\t')
    elif not targets:
        sources, targets = sources.split('\t')
...
modules = [pretrained_model.model.decoder, pretrained_model.lm_head, pretrained_model.model.shared] #Replace 5 by what you want
...
#     print(param, param.requires_grad)
    # param.requires_grad = False
# pretrained_model.base_model.encoder.requires_grad
